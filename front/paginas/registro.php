    ...
    <div class="row" id="cv">
      <div class="col-lg-12" id="cajalogin">
        ...
        <div class="row">  
          ...
          <hr>
              <label class="ticks"><input type="checkbox" id="cbox1" value="first_checkbox" name="condiciones" required> Acepto las normas y condiciones de uso.</label><br>
            ...
            <br>
          <button id = "botonenviar" type="submit" class="btn btn-primary" name="registrar">Registrarme</button>
        </form>
      </div>
    </div>
  </div>
